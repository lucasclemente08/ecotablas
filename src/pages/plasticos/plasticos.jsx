...
const Tablas = () => {
  ...
  const myData = [
    {
      label: "Polietileno",
      data: [{ primary: "Materiales", secondary: 300 }],
    },
    {
      label: "Polipropileno",
      data: [{ primary: "Materiales", secondary: 250 }],
    },
    {
      label: "PVC",
      data: [{ primary: "Materiales", secondary: 500 }],
    },
    {
      label: "Poliestireno",
      data: [{ primary: "Materiales", secondary: 200 }],
    },
  ];
      ...
      <div className="md:flex flex-row bg-slate-900">
        <div className="overflow-x-auto m-5">
          <div className="bg-white p-20  flex flex-col items-center rounded-md text-center">
            <div className=" p-32 flex items-center align-center justify-center w-full max-w-4xl"></div>
          </div>
        </div>
      </div>
    </>
