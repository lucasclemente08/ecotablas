...
const [EmpresaDonante,setEmpresaDonante] = useState([])
  const empresasDonantes = [
    ...
    },
    {
      ...
      "donacionesDisponibles": "Tubos de PVC, residuos industriales de polipropileno",
    ...
    <>
      <div className="md:flex flex-row bg-slate-900 min-h-screen">
        ...
        <div className="p-4 w-full">
          <h2 className="text-2xl font-bold text-white mb-4">Empresas Donantes</h2>
          <AddButton abrirModal={abrirModal} title={"Añadir empresa donante"} />
            <PdfGenerator columns={columns} data={empresasDonantes} title="Reporte de empresas donantes" />
                ...
                {empresasDonantes.map((empresa) => (
                  <tr key={empresa.id} className="hover:bg-gray-100">
                    ...
                    <td className="border-b py-3 px-4">
                      <a href={empresa.web} className="text-blue-600 hover:underline">{empresa.web}</a>
                    </td>
